...
interface ReaderVariantsDisplayProps {
  variants: ReaderVariant[];
  brandName: string;
  initialVariantId?: string;
}

export default function ReaderVariantsDisplay({
  variants,
  brandName,
  initialVariantId,
}: ReaderVariantsDisplayProps) {
  const [selectedVariant, setSelectedVariant] = useState<ReaderVariant>(
      ...
      <CardContent>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-1">
              <p className="text-sm text-muted-foreground">Available Powers</p>
              <div className="flex flex-wrap gap-1">
                {selectedVariant.power?.map((p) => (

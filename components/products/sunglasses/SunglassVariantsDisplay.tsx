...
interface SunglassVariantsDisplayProps {
  variants: SunglassVariant[];
  brandName: string;
  initialVariantId?: string;
}

export default function SunglassVariantsDisplay({
  variants,
  brandName,
  initialVariantId,
}: SunglassVariantsDisplayProps) {
  const [selectedVariant, setSelectedVariant] = useState<SunglassVariant>(

...
import { updateSunglassStockAction } from "@/actions/vendors/products";
import { useRouter } from "next/navigation";

export function SunglassVariantStock({ children, product }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await updateSunglassStockAction(
        product._id,
        operation,
        parseInt(quantity),
        selectedVariantId
                ...
                <div className="space-y-3">
                  ...
                  {selectedVariant.frame_color && (
                    <div className="text-sm">
                      ...
                      <div>
                        {selectedVariant.frame_color} frame •{" "}

...
interface SunglassVariantManagerProps {
...
export default function SunglassVariantManager({
  ...
  const updateVariant = (index: number, field: keyof SunglassVariant, value: any) => {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold">Sunglasses Variants</h3>

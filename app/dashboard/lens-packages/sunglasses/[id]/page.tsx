...
const SunglassDetails = async ({ id }: { id: string }) => {
  ...
  if (!resp.success) {
    return (
      <div className="text-center text-red-500 mt-6">
        Unable to get the details of your lens package
      </div>
    );
  }
  ...
  // Convert image URLs to signed URLs for display
    ...
    <div className="space-y-6 ">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/dashboard/lens-packages/sunglasses">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Sunglass Lens Package</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <Link href={`/dashboard/lens-packages/sunglasses/${id}/edit`}>
            <Button>Edit</Button>
          </Link>
          <DeleteLensPackageButton id={id} type="sunglasses" productCode={pkg.productCode} />
        </div>
      </div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-1">
                ...
                <p className="font-medium capitalize">{pkg.lens_color.replace("_", " ")}</p>
              </div>
              <div className="space-y-1">

        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Active businesses registered</p>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {vendorsData.data.length > 0
                  ? (
                      vendorsData.data.reduce((acc: number, v: Vendor) => acc + v.rating, 0) /
                ...
                <div className="flex gap-2">
                  {hasPrevPage && (
                    <Button variant="outline" asChild>
                      <Link
                        href={`/admin/vendors?page=${pagination.page - 1}&limit=${
                          pagination.limit
                  ...
                  <div className="flex gap-1">
                    {Array.from({ length: Math.min(5, pagination.totalPages) }, (_, i) => {
                      ...
                      return (
                        ...
                        >
                          <Link
                            href={`/admin/vendors?page=${pageNum}&limit=${pagination.limit}${
                              search ? `&search=${search}` : ""
                            }`}
                          >
                            {pageNum}

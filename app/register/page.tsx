                ...
                <div className="w-full max-w-sm space-y-8">
                    ...
                    <form className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="password" type="password" placeholder="Enter your password" className="w-full p-2 border rounded" />
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="confirm-password" type="password" placeholder="Confirm your password" className="w-full p-2 border rounded" />
